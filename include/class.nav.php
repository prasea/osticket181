...
class StaffNav
{
    ...
    function getTabs()
    {
        ...
        if (!isset($this->tabs)) {
            ...
            $this->tabs['blocks'] = array('desc' => __('Block'), 'href' => 'block.php', 'title' => __('Block System'));
...
class UserNav
{
    ...
    function getNavLinks()
    {
        ...
        if (!$this->navs) {
            ...
            $navs['block'] = array('desc' => __('Block System'), 'href' => 'block.php', 'title' => '');
            // $navs['pumori'] = array('desc' => __('Pumori Request'), 'href' => 'pumori.php', 'title' => '');
            ...
            if ($user && $user->isValid()) {
                if (!$user->isGuest()) {
                    $navs['tickets'] = array(
                        'desc' => sprintf(__('Tickets (%d)'), $user->getNumTickets($user->canSeeOrgTickets())),
                        'href' => 'tickets.php',
                        'title' => __('Show all tickets')
                    );
                } else {
                    $navs['tickets'] = array(
                        'desc' => __('View Ticket Thread'),
